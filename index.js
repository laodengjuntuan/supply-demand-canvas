...
canvas$1.addEventListener('mousedown', (e) => {
    ...
    let y = realYToLogicY(canvas$1.height + rect.top - PADDING - e.clientY);
...
function drawIntersection(point) {
  ...
  ctx.fill();
  ctx.moveTo(x, y);
  ctx.lineTo(x, canvas$1.height - PADDING);
  ...
  ctx.fillText(point.x.toFixed(2), logicXToRealX(point.x + 10), canvas$1.height - PADDING - 10);
